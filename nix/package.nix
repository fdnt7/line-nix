...
let
  ...
  #   comment     = opener of the first feature bullet in the Microsoft
  #                 Store "LINE Desktop" listing description, verbatim
  #                 (apps.microsoft.com/detail/xpfcc4cd725961). Picked
  #                 over the description's full first sentence (153 chars,
  #                 ~3x the longest Comment elsewhere on a typical desktop)
  #                 because the existing category is already conveyed by
  #                 GenericName / Keywords / Categories, so Comment is
  #                 free to extend the picture with the differentiating
  #                 capabilities (voice and video calls).
  desktopItem = makeDesktopItem {
    name = "line-messenger";
    desktopName = "LINE";
    genericName = "Messenger";
    comment = "Free voice and video calls any time, anywhere.";
    icon = "line-messenger";
    exec = "line";
    terminal = false;
    categories = [
